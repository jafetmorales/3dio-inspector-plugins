 ...
 * @version 0.0.6
 * @date 2018/10/26 05:31
 * @branch master
 * @commit 52a203750753b8ba90292867864c460a496f497e
...
(function (global, factory) {
	...
	var BUILD_DATE='2018/10/26 05:31', GIT_BRANCH = 'master', GIT_COMMIT = '52a203750753b8ba90292867864c460a496f497e'
	...
	function pickPointOnGroundPlane(args) {
	  ...
	  var tempCamera2=jquery.extend(true,{}, tempCamera);
	...
	function createListTabUi(args) {
	  ...
	  function setList(items) {
	    ...
	    if (items) items.forEach(function(item) {
	      ...
	      itemEl.addEventListener('dragstart', function onItemDragStart(e) {
	        ...
	        var el$$1 = document.querySelector('#mynameis');
	  ...
	  function onItemDrop(e) {
	    ...
	    // cameraEl.setAttribute('camera', 'active', false);
	      ...
	      cameraEl.setAttribute('camera', 'active', false);
	      el$$1.setAttribute('camera', 'active', true);
	    ...
	    var position = pickPointOnGroundPlane({
	      ...
	      playerPosition:el$$1.getObject3D('camera').position//playerPosition
	    });
	    // var position = pickPointOnGroundPlane({
	    //   x: playerPosition.x,
	    //   y: playerPosition.y,
	    ...
	    newPos.addVectors(position,el$$1.getObject3D('camera').position);
	    newPos.y=0;
	...
	function init$4() {
	  ...
	  listTab$3.setList(tensorModelItems);
